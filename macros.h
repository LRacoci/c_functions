//
// Created by lracoci on 26/01/2020.
//

#ifndef C_FUNCTIONS_MACROS_H
#define C_FUNCTIONS_MACROS_H
...
/*
 * When a macro is scanned and expanding, it creates a disabling context.
 ...
 * However, a disabling context only exists during one scan, so by deferring an expansion we can prevent our macros from becoming painted blue.
